...
3. (5 points) The parameter $\eta$ serves two important roles. It captures preferences for current consumption periods, but it also serves as an intertemporal preference parameter as we continue into the future. Why might $\eta$ also serve as an intertemporal preference parameter? 
...
9. (10 points) The damage function in this model has received a lot of criticism. Provide some arguments both for and against its use in informing environmental policy. 
...
11. (10 points) Recognizing that this is an important component of the SC-CO~2~, provide a reason for why having a empirically-estimated (positive) discount rate could be advantageous when designing environmental policy (hint: it might be helpful to keep in mind the ebb and flow of administrations and the need for resiliant and defensible environmental policy). 

  - Answer:

## Updating the DICE Damage Funtion to Weitzman (2012) (20 points for coding, 10 points for the answer)
The late great [Prof. Marty Weitzman](https://en.wikipedia.org/wiki/Martin_Weitzman) was a giant in the climate economics literature. He encouraged people tp think hard about difficult topics, particularly when it comes to accounting for risk and "fat tails" in climate-related damages. While his work is vast, in a paper titled [GHG Targets as Insurance Against Catastrophic Climate Damages](https://scholar.harvard.edu/files/weitzman/files/ghgtargetsinsuranceagainst.pdf) in 2012 he suggested altering the DICE damage function to help account for the potentially disastrous environmental outcomes from high warming scenarios, hedging against the unkown unkowns of the climate-economy relationship. His recommended modification was the second expression (the first expression is the base dice damage function): 
...
12. (5 points) In 1 to 3 sentences, provide an argument that supports using the basic Nordhaus damage function in federal benefit-cost analyses of government programs (hint: think back to a discussion we had about defensive behaviors and the advantage of using lower bound benefits estimates in analyses). 

  - Answer:
  
13. (5 points) Now, in 1 to 3 sentences, provide an argument _in favor_ of using the Weitzman damage function (instead of the basic Nordhaus damage function) in federal benefit-cost analyses (hint: this argument could be similar to the one made by Weitzman (2012)). 
